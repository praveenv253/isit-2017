...
\Sigma)$. We restrict our analysis to the ``sensor noise'' setting, wherein
$\m\Sigma = \sigma^2 \m I$, i.e. the sensors are afflicted by i.i.d.\ noise.
...
Recall that we are interested in computing lower bounds on the minimax risk for
the source localization problem defined in
Section~\ref{sec:source-localization}. We measure \emph{risk} in terms of the
